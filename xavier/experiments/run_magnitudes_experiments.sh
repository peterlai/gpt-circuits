...
EDGE_SELECTIONS=("random" "gradient")
UPSTREAM_LAYERS=(0 1 2)
...
do
  ...
  do
    ...
    do
      echo "Running experiment with layer $CURRENT_LAYER, $NUM_EDGES edges, $EDGE_SELECTION strategy..."
      ...
      python xavier/experiments/magnitudes_logits_from_edges.py \
        ...
        --seed $SEED \
        2>&1 | tee "${LOG_DIR}/layer${CURRENT_LAYER}_${EDGE_SELECTION}_edges_${NUM_EDGES}_${TIMESTAMP}.log"
      
      echo "Completed experiment with layer $CURRENT_LAYER, $NUM_EDGES edges, $EDGE_SELECTION strategy"
      echo ""
